 ...
 */
final class Version20250304125304 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participants_inscription (participants_id INT NOT NULL, inscription_id INT NOT NULL, INDEX IDX_B4C1F2745DAC5993 (inscription_id), INDEX IDX_B4C1F274838709D5 (participants_id), PRIMARY KEY(participants_id, inscription_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
