 ...
 */
final class Version20250311103243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participants_hackathon (participants_id INT NOT NULL, hackathon_id INT NOT NULL, INDEX IDX_76E0AC5C838709D5 (participants_id), INDEX IDX_76E0AC5C996D90CF (hackathon_id), PRIMARY KEY(participants_id, hackathon_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
